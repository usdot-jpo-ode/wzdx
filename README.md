...
- [**Creating a WZDx Feed**](/create-feed)
    - [**Example Feed GeoJSON Files**](/create-feed/examples)   
        ...
        - [MultiPoint Examples](/create-feed/examples/multipoint_examples)
            - [Comprehensive](/create-feed/examples/multipoint-examples/comprehensive_linestring_example.geojson)
            - [Local Access Only (bidirectional)](/create-feed/examples/multipoint-examples/local_access_only_bidirectional_linestring_example.geojson)
            - [Simple Work Zone](/create-feed/examples/multipoint-examples/scenario1_simple_linestring_example.geojson)
            - [Lane Shift](/create-feed/examples/multipoint-examples/scenario2_laneshift_linestring_example.geojson)
            - [Shoulder Closure (bidirectional)](/create-feed/examples/multipoint-examples/scenario3_shoulder_bidrectional_linestring_example.geojson)
            - [Detour](/create-feed/examples/multipoint-examples/scenario4_detour_linestring_example.geojson)
