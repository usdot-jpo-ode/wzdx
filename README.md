...
- [**Creating a WZDx Feed**](/create-feed)
    - [**Example Feed GeoJSON Files**](/create-feed/examples)
        - [Local Access Only (bidirectional)](/create-feed/examples/WZDxFeed/local_access_only_bidirectional_linestring_example.geojson)
        - [Simple Work Zone (LineString)](/create-feed/examples/WZDxFeed/scenario1_simple_linestring_example.geojson)
        - [Lane Shift](/create-feed/examples/WZDxFeed/scenario2_laneshift_linestring_example.geojson)
        - [Shoulder Closure (bidirectional)](/create-feed/examples/WZDxFeed/scenario3_shoulder_bidrectional_linestring_example.geojson)
