...
**direction**|Enumeration; Text|The digitization direction of the road that is impacted by the event.|Required|Example `northbound` (for I-5 North); See [Direction Enumerated Type](/feed-content/enumerated-types/derived-from-its-standards/direction.md)
