...
feed_update_date |	DateTime |	Designates the date and time
the data feed was last updated. |	Required	
feed_publisher |	Text |	The organization issuing the data feed. |	Optional	
feed_metadata |	URL |	A link to the metadata file (WZ-metadata.txt). |
See Section 2.6 for a description of the file. |	Optional	
