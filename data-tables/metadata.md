...
--------- | ----------- | -------
**issuing_organization** | The name of the issuing organization.<br>This name should match the name in the<br>road_events table(https://github.com/usdot-jpo-ode/jpo-wzdx/blob/v2editorial/data-tables/road_events.md). | “Anyplace public works”
