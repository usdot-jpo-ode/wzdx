...
**RoadRestrictions** | Data Frame | Multiple roadRestriction data frames may be used indicating restrictions applied to the work zone road segment associated with the work zone bounded by the begin/end locations | Optional | This data frame provides an array of roadRestrictions.
