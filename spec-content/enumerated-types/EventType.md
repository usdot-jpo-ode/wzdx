...
`restrictions-notice` | A linear segment, of the transportation network, with a permanent or persistent restriction(s).  Restrictions are regulations that limit how the transportation network can be used.
