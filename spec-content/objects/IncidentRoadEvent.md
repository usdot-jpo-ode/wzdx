...
`types_of_incident` | Array; One or More [Type of Incident](/spec-content/objects/TypeOfIncident.md) | A list of one or more incident types describing the cause of closure or restriction. | Required | Incident types are described using incident enumerations.
