...
`types_of_incident` | Array; One or More [Incident Types](/spec-content/enumerated-types/IncidentType.md) | A list of one or more incident types describing the cause of closure or restriction. | Required | Incident types are described using incident enumerations.
