...
`data_sources` | Array; [Road Event Data Source](/spec-content/objects/road_event_data_source.md)s | A list specific data sources for the road event data in the feed. | Required | Length of array must be at least one.
