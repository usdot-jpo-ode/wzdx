...
`data_source_id` | String | Identifies the data source from which the field device data originates. | Required | <br />Please see [Business Rule](/Creating_a_WZDx_Feed.md#business-rules) #4.
...
`update_date` | String; [date-time](https://tools.ietf.org/html/draft-handrews-json-schema-validation-01#section-7.3.1) | The UTC time and date when the field device information was updated. | Required | <br />Please see [Business Rule](/Creating_a_WZDx_Feed.md#business-rules) #5. 
