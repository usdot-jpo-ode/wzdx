...
`data_source_id` | String | Identifies the data source from which the road event originates. | Required | <br />Please see [Business Rule](https://user-images.githubusercontent.com/67278183/165163787-c8a0b71e-bc2c-4569-b848-3eff6d8389a6.png) #1.
