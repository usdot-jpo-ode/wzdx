...
`related_road_events` | Array; [RelatedRoadEvents](/spec-content/objects/RelatedRoadEvents.md) | A list describing one or more road events which are related to this road event, such as a work zone project it is part of or another road event that occurs before or after it in sequence. | Optional |
