...
`properties` | One of: [WorkZone](/spec-content/objects/WorkZone.md), [Detour](/spec-content/objects/Detour.md) | The specific details of the road event. | Required | This is a GeoJSON property.
