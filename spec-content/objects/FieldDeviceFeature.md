...
`properties` | One of: ArrowBoard, Camera, DynamicMessageSign, FlashingBeacon, LocationMarker, TrafficSensor | The specific details of the field device. | Required | This is a GeoJSON property.
