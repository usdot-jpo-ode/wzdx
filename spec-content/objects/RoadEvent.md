...
`restrictions` | Array; [[Restriction](/spec-content/objects/Restriction.md)] | Zero or more road restrictions applying to the work zone road segment associated with the work zone. | Optional | Restrictions can also be provided on an individual lane.
