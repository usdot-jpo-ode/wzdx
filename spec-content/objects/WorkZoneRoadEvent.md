...
`curbs_impact`| Array; [[CDSReference]](/spec-content/objects/CDSReference.md) | One or more references to external CDS [curb_zones](/https://github.com/openmobilityfoundation/curb-data-specification) impacted by the work zone. | Optional |
