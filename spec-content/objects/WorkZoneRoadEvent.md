...
--- | --- | --- | --- | ---
`core_details` | [RoadEventCoreDetails](/spec-content/objects/RoadEventCoreDetails.md) | The core details of the road event that are shared by all types of road events, not specific to work zones. | Required | Please see [Business Rule](/Creating_a_WZDx_Feed.md#business-rules) #3.
...
`lanes` | Array; \[[Lane](/spec-content/objects/Lane.md)\] | A list of individual lanes within a road event (roadway segment). | Optional | Please see [Business Rules](/Creating_a_WZDx_Feed.md#business-rules) #2 and #3.
