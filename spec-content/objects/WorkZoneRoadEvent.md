...
`impacted_cds_curb_zones`| Array; \[[CdsCurbZonesReference](/spec-content/objects/CdsCurbZoneReference.md)\] | A list of references to external [CDS Curb Zones](https://github.com/openmobilityfoundation/curb-data-specification/tree/main/curbs#curb-zone) impacted by the work zone. | Optional |
