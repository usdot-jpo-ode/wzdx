...
`restrictions` | [WorkZoneRoadEvent](/spec-content/objects/WorkZoneRoadEvent.md) | [RoadRestriction](/spec-content/enumerated-types/RoadRestriction.md) | Enumeration created in WZDx v1.0
