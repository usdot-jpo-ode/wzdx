...
Scenario 1 ([Linestring](/create-feed/examples/linestring-example/scenario1_simple_linestring_example.geojson) or [MultiPoint](/create-feed/examples/multipoint-examplescenario1_simple_multipoint_example.geojson))is based on the same numbered annotated work zones in [Discussion Topic 131](https://github.com/usdot-jpo-ode/jpo-wzdx/discussions/131) with a single lane closed on a multi-lane facility.
...
- Third work zone showing a work zone separated into multiple road events with detailed lane information.  Also demonstrates the use of relationship fields ("id": "65773-1", "65773-2", "65773-3").

### Scenario 2 - Lane Shift (simple case)
Scenario 2 ([Linestring](/create-feed/examples/linestring-example/scenario2_laneshift_linestring_example.geojson) or [MultiPoint](/create-feed/examples/multipoint-examplescenario2_laneshift_multipoint_example.geojson)) is based on the same numbered annotated work zones in [Discussion Topic 131](https://github.com/usdot-jpo-ode/jpo-wzdx/discussions/131) which keeps all lanes open but shifts them resulting in both shoulders being closed on a multi-lane facility.
...
- The comprehensive example ([Linestring](/create-feed/examples/linestring-example/comprehensive_linestring_example.geojson) or [MultiPoint](/create-feed/examples/multipoint-example/comprehensive_multipoint_example.geojson)) contains all of the examples listed above in a single GeoJSON file showing how the various road events across multiple organizations/data sources can be represented in a WZDx feed.
