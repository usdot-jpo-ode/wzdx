...
- The [TypesOfWork](/spec-content/objects/TypeOfWork.md.md) object describes the work taking place along the road.  If applicable, it indicates if the work changes the roadway's architecture.
- The [Lane](/spec-content/objects/Lane.md.md) object identifies and describes individual lanes within an event.
